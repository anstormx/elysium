...
def create_reverse_proxy_config_artifact(plan, args):
    ...
    l1rpc_service = plan.get_service("el-1-geth-lighthouse") #disable for sepolia
    ...
    return plan.render_templates(
        ...
        config={
            "haproxy.cfg": struct(
                ...
                data={
                    "l1rpc_ip": l1rpc_service.ip_address, #disable for sepolia
                    "l1rpc_port": l1rpc_service.ports["rpc"].number, #disable for sepolia
